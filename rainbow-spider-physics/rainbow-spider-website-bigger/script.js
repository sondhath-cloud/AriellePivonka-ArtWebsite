...
VerletJS.prototype.spider = function(origin) {
		...
		composite.head = new Particle(origin.add(new Vec2(0,-8)));
		composite.abdomen = new Particle(origin.add(new Vec2(0,16)));
		...
		// legs
		for (i=0;i<4;++i) {
			composite.particles.push(new Particle(composite.particles[0].pos.add(new Vec2(5,(i-1.5)*5))));
			composite.particles.push(new Particle(composite.particles[0].pos.add(new Vec2(-5,(i-1.5)*5))));
			...
			composite.particles.push(new Particle(composite.particles[len-2].pos.add((new Vec2(30,(i-1.5)*45)).normal().mutableScale(30*lenCoef))));
			composite.particles.push(new Particle(composite.particles[len-1].pos.add((new Vec2(-30,(i-1.5)*45)).normal().mutableScale(30*lenCoef))));
			...
			composite.particles.push(new Particle(composite.particles[len-2].pos.add((new Vec2(30,(i-1.5)*75)).normal().mutableScale(30*lenCoef))));
			composite.particles.push(new Particle(composite.particles[len-1].pos.add((new Vec2(-30,(i-1.5)*75)).normal().mutableScale(30*lenCoef))));
			...
			var rightFoot = new Particle(composite.particles[len-2].pos.add((new Vec2(30,(i-1.5)*150)).normal().mutableScale(18*lenCoef)));
			var leftFoot = new Particle(composite.particles[len-1].pos.add((new Vec2(-30,(i-1.5)*150)).normal().mutableScale(18*lenCoef)))
    ...
    var dpr = 1;
		...
		spider.drawConstraints = function(ctx, composite) {
			...
			ctx.beginPath();
			ctx.arc(spider.head.pos.x, spider.head.pos.y, 6, 0, 2*Math.PI);
			ctx.fillStyle = getColor(1);
			ctx.fill();
			
			ctx.beginPath();
			ctx.arc(spider.thorax.pos.x, spider.thorax.pos.y, 6, 0, 2*Math.PI);
			ctx.fill();
			
			ctx.beginPath();
			ctx.arc(spider.abdomen.pos.x, spider.abdomen.pos.y, 12, 0, 2*Math.PI);
			ctx.fill();
